...
void depthFirstSearch(vector<Point> &neighList, int numberOfPoints, int &time, vector<int> &reach, vector<int> &leave,
                      vector<vector<int>> &edgeType);

void
dfsTraversal(vector<Point> &neighList, int u, vector<int> &color, int &time, vector<int> &reach, vector<int> &leave,
             vector<vector<int>> &edgeType);
